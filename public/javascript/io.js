...
function attachMessage(message) {
    ...
    userMessageDiv.classList.add('bg-blue-500', 'text-white', 'p-3', 'rounded-lg', 'max-w-xs' , 'font-[comforta]');
...
function receiveMessage(message) {
    ...
    messageDiv.classList.add('bg-purple-500', 'text-white', 'p-3', 'rounded-lg', 'max-w-xs' , 'font-[comforta]');
